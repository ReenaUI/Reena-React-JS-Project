    ...
    render:function(){
        ...
        return (
            <g transform={transform}>
                <rect className={this.props.bgStyle} is width={width} height={height} rx="5" ry="5" visibility={visibility}/>
                <polygon className={this.props.bgStyle} is points="10,0  30,0  20,10" transform={transformArrow}
                         visibility={visibility}/>
                <text is visibility={visibility} transform={transformText}>
                    <tspan is x="0" className={this.props.textStyle1} text-anchor="middle">{this.props.xValue +" : "+this.props.tooltip.data.key}</tspan>
                    <tspan is x="0" className={this.props.textStyle2} text-anchor="middle" dy="25">{this.props.yValue +" : "+this.props.tooltip.data.value}</tspan>
                </text>
            </g>
        );
    }
